#
#  Be sure to run `pod spec lint VoiceConvert.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/DamianSheldon/VoiceConvert.git", :tag => s.version.to_s }
  ...
  s.source_files  = "VoiceConvert/VoiceConvert/**/*.{h,m,mm}"
